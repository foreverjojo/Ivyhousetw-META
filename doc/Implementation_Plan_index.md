...
| Idx-051 | 方案 A：以 Google 前置身分保護私有 Cloud Run 網站入口 | P0 | ⚠️ 有風險 | opencode | PASS WITH RISK | 2026-03-06-v1 | `doc/logs/Idx-051_log.md` | Plan：`doc/plans/Idx-051_plan.md`；LB+NEG+IAP 與自訂網域已落地，customer-owned OAuth client 已完成回綁且真人瀏覽器驗收通過；目前仍為 External/測試中，建議後續補公開條款頁與正式發布 |
